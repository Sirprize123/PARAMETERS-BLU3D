...
class SRCModifierApp:
    ...
    def create_ui(self):
        try:
            ...
            # Create a frame for the add buttons
            add_buttons_frame = ttk.LabelFrame(left_frame, text="Add Parameters", padding=(5, 5, 5, 5))
            add_buttons_frame.pack(fill='x', padx=5, pady=5)

            # Add print progress button with improved styling
            ...
            # Add Z height button with improved styling
