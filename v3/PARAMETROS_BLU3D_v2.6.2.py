...
class ParameterGraph:
    ...
    def plot_parameters(self, z_points, tool_points, feed_points, cool_points, act_drive_points):
        try:
            ...
            # Plot Tool Speed values with dots
            tool_values = [tool_points[z_points.index(z)] if z in z_points else 0 for z in z_ticks]
            ax1.plot(z_ticks, tool_values, label='Tool Speed', color='#ffb3ff', marker='o')  # Line with markers
            # ax1.scatter(z_points, tool_points, color='red')  # Remove this line
            ...
            # Plot Feed Rate values with dots
            feed_values = [feed_points[z_points.index(z)] if z in z_points else 0 for z in z_ticks]
            ax2.plot(z_ticks, feed_values, label='Feed Rate', color='#ffb3b3', marker='o')  # Line with markers
            # ax2.scatter(z_points, feed_points, color='red')  # Remove this line
            ...
            # Plot Cooling values with dots
            cool_values = [cool_points[z_points.index(z)] if z in z_points else 0 for z in z_ticks]
            ax3.plot(z_ticks, cool_values, label='Cooling', color='#87CEEB', marker='o')  # Line with markers
            # ax3.scatter(z_points, cool_points, color='red')  # Remove this line
            ...
            # Plot ACT_DRIVE values with dots
            act_drive_values = [act_drive_points[z_points.index(z)] if z in z_points else 0 for z in z_ticks]
            ax4.plot(z_ticks, act_drive_values, label='ACT_DRIVE', color='#90EE90', marker='o')  # Line with markers
            # ax4.scatter(z_points, act_drive_points, color='red')  # Remove this line
